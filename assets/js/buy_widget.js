	...
	jQuery('div[data-content-id]').each(function () {
		...
		if (dataArray.indexOf(buy_widgetid)) {
			...
			jQuery('div[data-content-id="' + buy_widgetid + '"]').each(function () {
				...
				var divProduct_name = "<div class='buy-content-itemname'><a href='" + product_url + "' target='_blank'>" + product_name + "</a></div>";
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            else // error
            {
                ...
                window.location.href = bw_domain + 'product.asp?itemid='+intCatalogID;
